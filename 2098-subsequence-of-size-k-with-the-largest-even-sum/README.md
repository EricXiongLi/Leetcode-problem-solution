...
<pre><strong>Input:</strong> nums = [4,1,5,3,1], k = 3
...
<pre><strong>Input:</strong> nums = [4,6,2], k = 3
<strong>Output:</strong> 12
<strong>Explanation:</strong>
...
<pre><strong>Input:</strong> nums = [1,3,5], k = 1
